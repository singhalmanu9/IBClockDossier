...
/**
 *  This class handles all the file writing for the
 *  Rubik's Clock Solver Dossier. It is similar to EasyWriter,
...
public class Writer
{
	   ...
	   *  @return true if an error occurred opening or writing to the file,
	   *  false otherwise
	   */
	  public boolean bad()
	  {
	  ...
	  /**
	   *  Writes a double number to the file
